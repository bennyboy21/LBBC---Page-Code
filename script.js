...
const observer5 = new IntersectionObserver(entries => {
    if(entries[0].isIntersecting == false) {
        document.getElementById("church-Name").classList.add("open")
        document.getElementById("home-Option").classList.add("open")
        document.getElementById("ministries-Option").classList.add("open")
        document.getElementById("upcoming-Option").classList.add("open")
    } else {
        document.getElementById("church-Name").classList.remove("open")
        document.getElementById("home-Option").classList.remove("open")
        document.getElementById("ministries-Option").classList.remove("open")
        document.getElementById("upcoming-Option").classList.remove("open")
    }
})

observer5.observe(mainText)
